      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {importedNFs && importedNFs.length > 0 && (
          <div className="bg-indigo-50 p-4 rounded-lg">
              ...
              {importedNFs.map((nf, idx) => (
                <div key={idx} className="bg-white/80 border rounded p-3 text-sm">
                  <div className="flex flex-wrap gap-3">
                    <div><span className="text-gray-500">NF:</span> <strong>{nf.nf_number || '—'}</strong></div>
                    <div><span className="text-gray-500">Série:</span> <strong>{nf.nf_series || '—'}</strong></div>
                    <div><span className="text-gray-500">Emissão:</span> <strong>{nf.nf_issue_date ? format(new Date(nf.nf_issue_date), 'dd/MM/yyyy') : '—'}</strong></div>
                  </div>
                  {nf.nf_access_key && (
            ...
            <p className="text-xs text-gray-500 mt-2">Obs: Os metadados acima serão salvos no campo "nf_imports" do recibo.</p>
          </div>
        )}
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Gestão de Compras e Recibos</h1>
      ...
      <Card>
        <CardContent className="p-6">
          ...
          {/* NOVA LINHA DE FILTROS AVANÇADOS */}
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>Órgão/Cliente</TableHead>
                      ...
                      <TableRow key={supply.id}>
                          ...
                          {supply.nf_imports && supply.nf_imports.length > 0 ? (
                            ...
                            <div className="flex flex-col text-sm">
                              ...
                              {supply.nf_issue_date && (
                                <span className="text-gray-500">Emissão: {format(new Date(supply.nf_issue_date), 'dd/MM/yyyy')}</span>
                              )}
                        ...
                        <TableCell>
                          <div className="flex justify-end space-x-2">
                            {/* Novo menu de opções para recibo */}
                            <DropdownMenu>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <div className="text-sm text-gray-600">Órgãos/Clients Atendidos</div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-6 text-center">
